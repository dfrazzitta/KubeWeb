...
namespace KubeApi.Controllers
{
    ...
    public class KubeController : ControllerBase
    {
        ...
        [HttpPost("[action]")]
        public string PostKrap([FromBody] string value)
        {
            return "ppp";
        }
        ...
        public V1PodList PostPodList([FromBody] kubeParams value) //string jsonInput)
        {
            ...
            var list = client.CoreV1.ListNamespacedPod(value.kubenamespace); //.ListNamespace();

            return list;
        }

        [HttpPost("[action]")]  // There are HttpGet, HttpPost, HttpPut, HttpDelete.
        public V1ServiceList PostSvcList([FromBody] kubeParams value) //string jsonInput)
        {

            var k8SClientConfig = KubernetesClientConfiguration.BuildConfigFromConfigFile("/app/config");
            IKubernetes client = new Kubernetes(k8SClientConfig);

            var list = client.CoreV1.ListNamespacedService(value.kubenamespace); //.ListNamespace();
        ...
        */
        ...
        //[Route("ListComponentStatusList")]
        //[HttpGet] // There are HttpGet, HttpPost, HttpPut, HttpDelete.
        [HttpPost("[action]")]
        public V1ComponentStatusList PostListComponentStatusList([FromBody] string value)
        {
            var k8SClientConfig = KubernetesClientConfiguration.BuildConfigFromConfigFile("/app/config");
            IKubernetes client = new Kubernetes(k8SClientConfig);

            var list = client.CoreV1.ListComponentStatus();
        ...
        //[HttpGet] // There are HttpGet, HttpPost, HttpPut, HttpDelete.
        [HttpPost("[action]")]
        public V1NodeList PostNodesList([FromBody] kubeParams value)
        {
            var k8SClientConfig = KubernetesClientConfiguration.BuildConfigFromConfigFile("/app/config");
            IKubernetes client = new Kubernetes(k8SClientConfig);

            switch (value.kubeaction)
            {
            ...
            var list = client.CoreV1.ListNode();
        ...
        // PUT api/<KubeController>/5
        [HttpPut("{id}")]
        public void Put(int id, [FromBody] string value)
        {
        }

        // DELETE api/<KubeController>/5
        [HttpDelete("{id}")]
